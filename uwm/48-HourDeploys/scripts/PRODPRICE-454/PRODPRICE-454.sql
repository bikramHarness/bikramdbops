...
/****** Object:  StoredProcedure [dbo].[USFS_WaiveEscrowsCheckEligible]    Script Date: 3/27/2025 9:11:15 AM ******/
SET ANSI_NULLS ON
GO
...
--P Hinman 03/27/2025 Add Logic for FTHB - HTML combination (HTML fail does not qualify for FTHB)
--                    Cleanup "very bad" logic with "less bad" logic (still ugly code but we do not have testing capacity to rewrite properly)
--*****************************************************************************************  
...
BEGIN  
  ...
  IF (@FirstTimeHomeBuyer = 'Y' AND @HPML = 0)  
  BEGIN  
   SET @returnVal = 
