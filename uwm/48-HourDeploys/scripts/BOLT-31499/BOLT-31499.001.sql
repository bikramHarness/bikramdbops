...
-----------------------------------------------------------------------------------------------------------                      
   ...
   9 Saluru		3/27/2025 Added agencycasenumber from Loan_main to retrieve CaseNumber
**********************************************************************************************************/
...
BEGIN
    ...
    DECLARE @AppraisalParcelId VARCHAR(256),
			...
			@AgencyCaseNumber VARCHAR(20), --BOLT-31499
    ...
    SELECT @Propertyrecordid = lm.propertyrecordid,
		   ...
		   @AgencyCaseNumber = lm.agencycasenumber   --BOLT-31499
    ...
    SELECT @PurposeTypeId AS PurposeTypeId,
		   ...
		   @AgencyCaseNumber AS AgencyCaseNumber,  --BOLT-31499
